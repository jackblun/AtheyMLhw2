...
# Honest causal tree. Note that this is more manual than Athey wants. Could do just in honest causal tree command.

```{r hon.causal.tree, echo=F, message=FALSE, warning=FALSE}
...
```{r obs causal.f, echo=F, message=FALSE, warning=FALSE}
